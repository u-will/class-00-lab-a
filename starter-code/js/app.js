...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT:  it threw an error because the variable declaration let is for the scope variable and we were using it ouitside of scope as a globol one. 
  console.log(viewed);
